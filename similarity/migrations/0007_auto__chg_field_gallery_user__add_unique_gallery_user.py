...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gallery.user'
        db.alter_column(u'similarity_gallery', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['similarity.User'], unique=True, null=True))
        # Adding unique constraint on 'Gallery', fields ['user']
        db.create_unique(u'similarity_gallery', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gallery', fields ['user']
        db.delete_unique(u'similarity_gallery', ['user_id'])


        # Changing field 'Gallery.user'
        db.alter_column(u'similarity_gallery', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['similarity.User']))
    ...
    models = {
        ...
        u'similarity.gallery': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['similarity.User']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
