...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'similarity_questionnaire', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'similarity', ['Questionnaire'])

        # Adding M2M table for field questions on 'Questionnaire'
        m2m_table_name = db.shorten_name(u'similarity_questionnaire_questions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('questionnaire', models.ForeignKey(orm[u'similarity.questionnaire'], null=False)),
            ('question', models.ForeignKey(orm[u'domande.question'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'similarity_questionnaire')

        # Removing M2M table for field questions on 'Questionnaire'
        db.delete_table(db.shorten_name(u'similarity_questionnaire_questions'))
